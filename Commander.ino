...
char *folder_descriptions[6] = {"The Main things","MacOS File manager","commands for working with text","MacOS global commands","Restart, Shutdown, etc.", "Cool stuff to know"};
...
void menu_Animation() {
    ...
    Serial.println("Should do the menu animation now");
    ...
    if (MenuAnimation == true) {
        ...
        display.println(folder_descriptions[0]);
